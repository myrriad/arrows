...
public class ArrowShearRenderer extends Gui{
	...
	private int MAX;
	   ...
	   */
	  private final static ResourceLocation overlayBar = new ResourceLocation(ForceArrows.MODID,
	  ...
	  private ArrowShearRenderer(Minecraft mc) {
	    this.mc = mc;
	  }
