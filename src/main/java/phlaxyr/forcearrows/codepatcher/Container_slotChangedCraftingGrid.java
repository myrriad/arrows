...
import static phlaxyr.forcearrows.codepatcher.PatchTransformer.get;
import static phlaxyr.forcearrows.codepatcher.PatchTransformer.obfdesc;
...
//		mv.visitMethodInsn(INVOKESTATIC, "phlaxyr/forcearrows/craftingarrow/ArrowManager", "injectArrowResult", "(Lnet/minecraft/inventory/Container;Lnet/minecraft/inventory/InventoryCrafting;Lnet/minecraft/item/ItemStack;Lnet/minecraft/world/World;)Lnet/minecraft/item/ItemStack;", false);
//		mv.visitVarInsn(ASTORE, 6);
	...
	public void onCodeNotFound() {
		ForceArrows.lumberjack.error("NOT FOUND! ForceArrows can't seem to find the code line \"res.setInventorySlotContents(0, itemstack);\"!");
		throw new IllegalStateException("ForceArrows can't seem to find the code line \"res.setInventorySlotContents(0, itemstack);\"!");
