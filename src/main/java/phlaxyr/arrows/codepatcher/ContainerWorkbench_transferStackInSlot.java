...
class ContainerWorkbench_transferStackInSlot implements MethodFixer {
	...
	public InsnList getInsnsToInject(boolean obf, int varCode) {
		...
		// mv.visitMethodInsn(INVOKESTATIC, "phlaxyr/arrows/craftingarrow/ArrowManager", "onCraftArrow", "(Lnet/minecraft/inventory/ContainerWorkbench;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/world/World;Lnet/minecraft/entity/player/EntityPlayer;)Z", false);

		
		
		// mv.visitMethodInsn(INVOKESTATIC, "phlaxyr/arrows/craftingarrow/ArrowManager", "onCraftArrow", "(Lnet/minecraft/inventory/ContainerWorkbench;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/world/World;)Z", false);
	...
	{
		Arrows.lumberjack.error("NOT FOUND! Arrows can't seem to find the code line \"if (index == 0){\"!");
		throw new IllegalStateException("Arrows can't seem to find the code line \"if (index == 0){\"!");
