package phlaxyr.largetents.craftingarrow;
...
import phlaxyr.largetents.packet.PacketDisplayFrame;
import phlaxyr.largetents.packet.PacketHandler;

public class ArrowManager {
	// public static final Delegate renderer = new Delegate();
	// public static class Delegate extends NullableDelegate<largetentshearRenderer>{}
