...
class ContainerWorkbench_transferStackInSlot implements MethodFixer {
	...
	public InsnList getInsnsToInject(boolean obf, int varCode) {
		...
		// mv.visitMethodInsn(INVOKESTATIC, "phlaxyr/largetents/craftingarrow/ArrowManager", "onCraftArrow", "(Lnet/minecraft/inventory/ContainerWorkbench;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/world/World;Lnet/minecraft/entity/player/EntityPlayer;)Z", false);

		
		
		// mv.visitMethodInsn(INVOKESTATIC, "phlaxyr/largetents/craftingarrow/ArrowManager", "onCraftArrow", "(Lnet/minecraft/inventory/ContainerWorkbench;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/world/World;)Z", false);
	...
	{
		LargeTents.lumberjack.error("NOT FOUND! LargeTents can't seem to find the code line \"if (index == 0){\"!");
		throw new IllegalStateException("LargeTents can't seem to find the code line \"if (index == 0){\"!");
