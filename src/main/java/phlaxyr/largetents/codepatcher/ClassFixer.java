...
import static phlaxyr.largetents.codepatcher.ObfUtil.obf;
...
class ClassFixer {
	...
	public byte[] fixClass(byte[] bytes, String classNameOfBytes) {
		...
		LargeTents.lumberjack.info("********* INSIDE " + (obfuscated ? "OBFUSCATED" : "NORMAL") + " TRANSFORMER ABOUT TO PATCH: "+target);
		...
		LargeTents.lumberjack.info("********* " + (obfuscated ? "OBFUSCATED" : "NORMAL") + " TRANSFORMER HAS FINISHED PATCHING: "+target);
