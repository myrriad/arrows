 ...
 */
public abstract class PacketServerHandler<REQ extends IMessage, REPLY extends IMessage> implements IMessageHandler<REQ, REPLY>{
	...
	public REPLY onMessage(final REQ message, MessageContext ctx) {
		...
		final WorldServer playerWorldServer = ctx.getServerHandler().player.getServerWorld();
